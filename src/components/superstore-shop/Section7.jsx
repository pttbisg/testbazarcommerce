    ...
    mb: "70px"
      ...
      <FlexBox>
        ...
        height: "100%"
          ...
          {list.map(brand => <ProductCategoryItem key={brand} title={brand} imgUrl={`/assets/images/${type}/${brand}.png`} isSelected={!!selected.match(brand)} onClick={handleCategoryClick(brand)} sx={{
          mb: "0.75rem",
