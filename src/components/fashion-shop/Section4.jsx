  ...
  return <CategorySectionCreator title="Deal Of The Week">
      ...
      position: "relative"
        ...
        right: 0
          ...
          <BazarIconButton onClick={handleSlideChange(currentSlide - 1)} disableRipple mr="0.5rem" sx={buttonStyled("white", "primary.500")}>
            <ArrowBack fontSize="small" color="secondary" />
          </BazarIconButton>

          <BazarIconButton onClick={handleSlideChange(currentSlide + 1)} disableRipple sx={{ ...buttonStyled("primary.500", "white"),
          color: "white"
        }}>
      ...
      <Box mt={-0.5} mb={-0.5}>
        <Carousel totalSlides={totalSlides} visibleSlides={1} showArrow={false} showDots currentSlide={currentSlide}>
