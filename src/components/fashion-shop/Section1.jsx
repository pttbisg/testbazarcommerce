...
const Section1 = () => {
  return <Fragment>
      ...
      mb: "4rem"
        ...
        <Grid container spacing={3}>
          <Grid item md={3} xs={6}>
            <ShowcaseCard4 Icon={CreditCardVerifiedIcon} title="Secure Payment" body="100% secured payment & privacy" />
          </Grid>
          <Grid item md={3} xs={6}>
            <ShowcaseCard4 Icon={FeedbackThumbsUpIcon} title="Great Feedback" body="More than 97% positive & happy customers" />
          </Grid>
