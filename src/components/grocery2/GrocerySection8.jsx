...
const GrocerySection8 = ({
  ...
  return <Box>
      ...
      <Box my="-0.25rem">
        <Carousel totalSlides={9} visibleSlides={visibleSlides} step={3} showDots arrowButtonColor="inherit" showArrowOnHover={true}>
          {products && products.map((item, ind) => <Box py={0.5} height="100%" key={ind}>
