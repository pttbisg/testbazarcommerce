...
const Section5 = () => {
  return <SectionWrapper id="price">
      <Container id="section-3" sx={{
      position: "relative"
    }}>
        <H2 color="secondary.main" maxWidth="830px" mx="auto" mb={9} textAlign="center" fontSize="40px" fontWeight="900">
        ...
        <FlexBox flexWrap="wrap" justifyContent="center" m={-2.65}>
          ...
          px: "1rem",
          m: "1.325rem"
        }} elevation={2} hoverEffect>
            <H3>Regular</H3>
            <Box position="relative" display="inline-block" mb={3}>
              <H3 fontSize="72px" color="secondary.main">
                28
              </H3>
              <Box position="absolute" top="1rem" left="-1rem" fontWeight="600" fontSize="16px">
                $
              </Box>
            </Box>
            ...
            <Link href="https://material-ui.com/store/items/bazar-pro-react-ecommerce-template/" passHref={true}>
