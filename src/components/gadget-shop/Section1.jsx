      ...
      pt: "3rem"
        ...
        <Grid container spacing={5}>
          <Grid item md={5} xs={12}>
            <Carousel totalSlides={mainCarousel.length} visibleSlides={1} leftButtonStyle={{ ...arrowButtonStyle,
            left: 8
          }} rightButtonStyle={{ ...arrowButtonStyle,
            right: 8
          }}>
              {mainCarousel.map((_item, ind) => <CarouselCard3 carouselData={_item} key={ind} />)}
            </Carousel>
          </Grid>
