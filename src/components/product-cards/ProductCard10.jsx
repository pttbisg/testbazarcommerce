      ...
      <ImageWrapper>
        ...
        <HoverButtonBox className="hoverButtonBox">
          <Box className="buttonBox">
            ...
            <Button color="primary" variant="outlined" className="addCartButton" onClick={handleCartAmountChange(cartItem?.qty ? cartItem.qty - 1 : (cartItem?.qty || 0) + 1)}>
              {cartItem?.qty ? <>
                  <Remove />
                  Remove from Cart
                </> : <>
